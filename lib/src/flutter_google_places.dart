...
class _PlacesAutocompleteOverlayState extends PlacesAutocompleteState {
  ...
  Widget build(BuildContext context) {
    ...
    if (_searching) {
      body = Stack(
        children: <Widget>[
           widget.logo ?? AppBarPlacesAutoCompleteTextField(),
          _Loader()
        ],
      ...
      body = Material(
        color: theme.dialogBackgroundColor,
//        child: widget.logo ?? AppBarPlacesAutoCompleteTextField(),
        borderRadius: BorderRadius.only(
...
class _PlacesAutocompleteResult extends State<PlacesAutocompleteResult> {
  ...
  Widget build(BuildContext context) {
    ...
    if (state._queryTextController.text.isEmpty ||
      ...
      children.add(widget.logo ?? AppBarPlacesAutoCompleteTextField());
...
//          autofocus: true,
          ...
          decoration: new InputDecoration(
              hintText: "Ingrese la dirección para el servicio",
...
class PlacesAutocomplete {
  static Future<Prediction> show(
      ...
      String hint = "Ingrese la direccion",
      num offset,
      Location location,
      num radius,
      String language,
